...
{
    /// <summary>
    /// Логика взаимодействия для EditKartina.xaml
    /// </summary>
    public partial class EditKartina : Page
    {

        public int id;

        public EditKartina(Item selectedItem)
        {
            InitializeComponent();
            // Получение данных
            try
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            using (ArtHistoryDBEntities db = new ArtHistoryDBEntities())
            {
                ...
                TbKartini table = db.TbKartini.ToList().Find(t => t.Id == id); // здесь selectedId - идентификатор выбранной строки
