...
{
    /// <summary>
    /// Логика взаимодействия для EditHudozhnik.xaml
    /// </summary>
    public partial class EditHudozhnik : Page
    {
        public int id;

        public EditHudozhnik(Item selectedItem)
        {
            InitializeComponent();
            // Получение данных
            try
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            using (ArtHistoryDBEntities db = new ArtHistoryDBEntities())
            {
                ...
                TbHudozhniki table = db.TbHudozhniki.ToList().Find(t => t.Id == id); // здесь selectedId - идентификатор выбранной строки

                // Получить текст из RichTextBox
                string opisanieText = new TextRange(tbBiografia.Document.ContentStart, tbBiografia.Document.ContentEnd).Text;
